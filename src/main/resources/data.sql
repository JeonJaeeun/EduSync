...
VALUES
    ('student1@example.com', 'hashed_password1', 'Student1', '01012345678', 'High School A', 'STUDENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('parent1@example.com', 'hashed_password2', 'Parent1', '01087654321', 'High School A', 'TUTOR', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('teacher1@example.com', 'hashed_password3', 'Teacher1', '01055556666', 'High School A', 'TUTOR', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
